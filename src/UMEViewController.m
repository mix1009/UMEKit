...
@property (nonatomic, readwrite, strong) NSBundle *nibBundle;
@property (nonatomic, readwrite, assign) UMEViewController *parentViewController;
@property (nonatomic, readwrite, strong) UMENavigationItem *navigationItem;
@property (nonatomic, readwrite, strong) UMENavigationController *navigationController;
@property (nonatomic, readwrite, strong) UMETabBarController *tabBarController;
@end
...
- (void)loadView {
    if ([nibName length]) {
        NSNib *nib = [[NSNib alloc] initWithNibNamed:nibName bundle:nibBundle];
...
//        [view autorelease];
        ...
        self.view = [[UMEFlippedView alloc] initWithFrame:NSMakeRect(0, 0, MAXFLOAT, MAXFLOAT)];
...
- (UMENavigationItem *)navigationItem {
    if (!navigationItem) {
        self.navigationItem = [[UMENavigationItem alloc] initWithTitle:title];
